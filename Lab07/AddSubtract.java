...
/**--------------------------------------------NOTES--------------------------------------------
 * main.01
 * 		Outputs the sum and difference of x and y and notifies the user that the operation has 
 * 		been handled inside the method;
 * main.o2
 * 		Outputs the sum and difference of x and y, notifying the user that the operations have 
 * 		been handled seperately from within main;
 * 
 * checkShouldLoop.01
