...
public class Tornado {
	public static void main(String[] args) {
		...
		//DETERMINE COLOR
		if(wavelength > 0 && wavelength <= 40) {color = "not even an F-0.";}
		else if(wavelength > 40 && wavelength <= 72) {color = "F-0.";}
		else if(wavelength > 72 && wavelength <= 112) {color = "F-1.";}
		else if(wavelength > 112 && wavelength <= 157) {color = "F-2.";}
		else if(wavelength > 157 && wavelength <= 205) {color = "F-3.";}
		else if(wavelength > 205 && wavelength <= 260) {color = "F-4.";}
		else if(wavelength > 260 && wavelength <= 305) {color = "F-5.";}
