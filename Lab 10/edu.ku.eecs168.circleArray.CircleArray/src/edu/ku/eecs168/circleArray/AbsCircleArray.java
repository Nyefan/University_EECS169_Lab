...
import edu.ku.eecs168.circleArray.R;
import edu.ku.swingemu.AndroidJApplet;

public abstract class AbsCircleArray extends AndroidJApplet{
		...
		b.setPositiveButton("Ok", new OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				try{
					...
					Toast.makeText(AbsCircleArray.this, "Please enter a number.", Toast.LENGTH_SHORT).show();
				}
			}
		});
		b.show();
